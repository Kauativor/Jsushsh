...
local WEBHOOKS = {
    ...
    "https://discord.com/api/webhooks/1448072473588273162/oGiGgNRv4PS46ZpghjlUDaOrnCA4-pN1H366KGChNXS31ttVzF6nou9V30oIiRhM6mmw",  --WEBHOOK 2
}
...
local function SendWebhook(extraFields)
    ...
    local payloadTable = {
        username = "by: y6",
        embeds = {{
            title = "🔗 auto BNX | " .. timeStr,
            color = 16732240,
            fields = extraFields,
            image = {
                url = "https://cdn.discordapp.com/attachments/1448120137130704936/1448129131085692949/file_00000000b48c71f5b42e0773a326cf4b2.png?ex=693a22d9&is=6938d159&hm=d27ac0190229f1b7492e086bae03a3f916dd4820d23813a25dd748a3856299cb"
            }
        }}
    }
...
loaderTitle.Text = "auto bnx X moreira..."
